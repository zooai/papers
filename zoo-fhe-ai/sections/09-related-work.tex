...
\textbf{On-chain FHE}: Lux FHEVM~\cite{lux-fhevm} brings \TFHE{} to the EVM via native precompiles at \texttt{0x...80}--\texttt{0x...83} with consensus-deterministic keygen. Zoo FHE extends this with \CKKS{} support for efficient linear algebra (ML inference) and threshold decryption at the \TChain{} layer.
