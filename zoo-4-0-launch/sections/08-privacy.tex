...
\Zoo{} 4.0 supports two complementary privacy paths via \Lux{}
...
The \Zoo{} 4.0 wallet (\S\ref{sec:wallet-desktop}) exposes a privacy
...
on the \GPU{}. The privacy primitives in \Zoo{} 4.0 are not bolted on
