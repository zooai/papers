...
struct NftLoanAgreement3 {
    ...
    Ringtail::Sig lender_sig;          // Ringtail signature, threshold capable
    Hash      l1_anchor;               // Quasar 3.0 cert reference
};
\end{lstlisting}

The borrower signs with $\MLDSA{}\text{-}65$ to bind individual
identity. The lender signs with \Ringtail{}, threshold-capable so
...
\Ringtail{} threshold key. The threshold structure means individual
