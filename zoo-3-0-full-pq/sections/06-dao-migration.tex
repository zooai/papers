...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item \textbf{Governance proposal-signing key.} Threshold
        \Corona{} for proposal hashes (PQ-safe with smaller
...
\subsection{Why threshold ML-DSA + Corona and not just one}
...
ecosystem auditability. Proposal-signing uses \Corona{} because
