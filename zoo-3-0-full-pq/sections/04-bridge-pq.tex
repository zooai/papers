...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item \textbf{\Ringtail{} co-attestation.} The committee additionally
        emits a \Ringtail{} threshold proof over the same digest.
  ...
  \item \textbf{Destination mint.} The destination contract verifies
        ...
        \Ringtail{} via the verifier shipped in 3.0 --- and only
        then mints.
\end{enumerate}
...
destination chain. Requiring both \Ringtail{} (Ring-LWE) and
...
\begin{itemize}[leftmargin=1.2em]
  \item Every 90 days the committee runs a key-refresh ceremony,
        rotating each member's $\MLDSA{}$ and \Ringtail{} share.
...
(BSC does not implement \MLDSA{} or \Ringtail{} verification), but
...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item \textbf{Lattice scheme break.} If a published break of either
        \Ringtail{} or $\MLDSA{}$ surfaces, the bridge halts pending
