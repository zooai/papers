...
\Corona{} \cite{lp-073}, LP-070 for $\MLDSA{}\text{-}65$
\cite{lp-070}.
...
\begin{enumerate}[leftmargin=1.4em]
  ...
  \item \textbf{\Corona{} threshold (LP-073).}
...
independent PQ assumptions: \Corona{} relies on Ring-LWE hardness;
...
struct QuasarCert3 {
    ...
    corona::ThresholdSig   corona_proof; // ~2.0-2.4 KB
...
bool verify_3_0(const QuasarCert3& c, const ValidatorSet& vs) {
    ...
    if (!corona_verify(c.corona_proof, c.block_root, vs)) return false;
