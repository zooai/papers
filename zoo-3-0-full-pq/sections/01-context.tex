...
Governance keys & ECDSA per signer & threshold $\MLDSA{}\text{-}65$ + \Ringtail{} \\
...
NFT Liquidity loans & ECDSA loan agreements & \Ringtail{}-signed loan agreements \\
DAO vote receipts & on-chain ECDSA & \MLDSA{}-65 signed, optional \FHE{} ballot \\
Inference receipts & A-Chain TEE quote & TEE quote + \Ringtail{}-anchored attribution \\
...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item Application contracts written for 2.0 continue to work in 3.0;
        new precompiles for \Ringtail{} verification are additive,
        not breaking.
