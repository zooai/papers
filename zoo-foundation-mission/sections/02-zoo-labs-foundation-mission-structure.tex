...
Chief Scientist \textbf{Antje Worring} leads Zoo Labs Foundation's AI research program. In October 2021, Worring co-authored the Zoo whitepaper proposing a GUI-based conversational AI assistant for conservation education---a consumer LLM chat interface that predates OpenAI's ChatGPT (November 2022) by thirteen months. Worring designed the UX/UI interaction model, co-specified the Experience Ledger semantic memory architecture, and directs the six-thrust AI research agenda detailed in the companion research agenda paper.
