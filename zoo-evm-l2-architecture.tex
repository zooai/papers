...
\author[1]{Zach Kelling\thanks{zach@lux.network}}
...
\multirow{3}{*}{Threshold Sig} & FROST & \texttt{0x0800...02} & RFC 9591 \\
 ...
 & Ringtail & \texttt{0x0200...0B} & Ring-CT \\
\midrule
...
\bibitem{liquid-evm} Kelling, Z. ``Liquid EVM: On-Chain Securities Settlement with Post-Quantum MPC Custody.'' Liquidity Exchange, 2026.
