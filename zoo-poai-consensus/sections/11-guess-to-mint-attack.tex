...
The remainder of this paper builds the missing predicate as a \emph{software-only}
artifact---no enclave, no special hardware---that is a side effect of the genuine
computation, that cannot be produced without performing the matmuls, and that any
participant can both emit and check against a network-shared difficulty.
