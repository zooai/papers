\section{The 3.0 Thesis}
\label{sec:thesis}

\Zoo{} 3.0 is 100\% \GPU{}-powered. The fastest blockchain plus consensus plus
...
In the \Zoo{} 3.0 stack, every primitive whose latency matters at validator
...
\begin{itemize}[leftmargin=1.2em]
  \item Triple-consensus signature verification (\BLS{}12-381 aggregate +
        \Ringtail{} threshold + \MLDSA{}-65 identity) runs as fused
...
the memory wall or the per-core ceiling. \Zoo{} 3.0 takes the entire
...
\subsection{What \Zoo{} 3.0 is not}

\Zoo{} 3.0 is not a marketing rename. It is not an upgrade only to consensus
...
cores. \Quasar{} 3.0 ships with triple-consensus support, certificate
...
runs the AI compute. \Zoo{} 3.0 is the first chain to take that loop
seriously.
