...
This section breaks down what runs on the \GPU{} in \Zoo{} 3.0 and why each
...
\subsection{Consensus (\Quasar{} 3.0, LP-020 + LP-135)}

\Quasar{} 3.0 ships triple-consensus:
...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item \textbf{\Ringtail{} (Ring-LWE)} --- post-quantum threshold proof.
...
default 3.0 mode runs all three in parallel and emits a \Quasar{}Cert
...
The \Zoo{} 3.0 \textsc{evm} is a fiber \textsc{vm}:
