...
\begin{enumerate}[leftmargin=1.4em]
  \item \textbf{$\BLS{}_{12\text{-}381}$ aggregate.} 48 bytes.
        ...
        propagation.
  \item \textbf{\Ringtail{} threshold.} Post-quantum threshold
...
\Ringtail{} and $\MLDSA{}$ proofs do not depend on classical hardness
...
once $\BLS{}$ falls, the \Ringtail{} and $\MLDSA{}$ proofs continue
...
\begin{itemize}[leftmargin=1.2em]
  ...
  \item Threshold \Ringtail{} key for post-quantum threshold
        operations.
\end{itemize}
...
bool verify_trade_finality(
    ...
    if (!ringtail_verify(cert.ringtail, cert.block_root, vs)) return false;
...
\begin{itemize}[leftmargin=1.2em]
  \item \textbf{Single lattice scheme break.} If a published break
        of either \Ringtail{} or $\MLDSA{}$ surfaces, trading halts
