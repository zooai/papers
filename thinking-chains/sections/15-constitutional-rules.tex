...
\item \textbf{No live thought in state transition.} A state transition may not depend on live thought or a live cross-chain query; cognition enters only via Pattern A / Pattern B. (The Bridge Law, Principle~\ref{prin:bridge}.)
