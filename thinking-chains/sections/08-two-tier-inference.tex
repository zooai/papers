...
The Bridge Law tells us \emph{how} cognition re-enters state (as a verified receipt). It does not tell us \emph{how the answer is produced}. There are two regimes, divided by a hard physical fact: whether the model's forward pass is bit-reproducible across heterogeneous hardware. This fact, not cost, is the dividing line.
