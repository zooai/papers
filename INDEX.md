# Zoo Labs Foundation -- Paper Index

**Organization**: Zoo Labs Foundation Inc, 501(c)(3)
**Chief Scientist**: Antje Worring
...
|------|-------|-------------|
| **Oct 2021** | Zoo Whitepaper | GUI-based LLM chat assistant proposed -- 13 months before ChatGPT (Nov 30, 2022) |
| **Oct 2021** | Zoo Foundation Mission | Founding mission: AI + blockchain + conservation |
| **Oct 2021** | Zoo Experience Ledger | Content-addressable semantic memory -- predates mainstream vector databases |
| **2024** | Zoo AI Research Agenda | Six-thrust research program formalizing the 2021 vision |
| **2024** | HLLM / Training-Free GRPO | Hamiltonian LLMs and semantic optimization |
...
| **2025-12-15** | Zoo 2025: Securities and DAO | Five planks: updated team, $113T digital-securities positioning (Lux + Liquidity), Quasar 3.0 quantum-secure settlement (BLS + Ringtail + ML-DSA), Homomorphic / Holographic Consensus DAO with weighted voting, democratized end-to-end information access |
...
| **2025-10-31** | Zoo 3.0 Full Post-Quantum Stack | Full PQ era -- every signature, every commitment, every proof in Ringtail + ML-DSA-65 + BLS schemes. Triple-cert inheritance from Lux Quasar 3.0 (LP-020). DAO migration, Bridge re-keying, NFT Liquidity PQ, zLLM PQ commitments. Spec freeze 2025-10-31 (founder's anniversary) |
...
| Zoo Eco-1 / Z-JEPA | `zoo-eco1-zjepa/zoo-eco1-zjepa.tex` |
...
### Experience Ledger and Semantic Memory
...
### Blockchain and Network Architecture
